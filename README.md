    ...
    <div class="container">
      <table>
        ...
        <tbody>
		  ...
		  <tr>
            <td>IsBonusCountEditAllowed</td>
            <td>Разрешение редактирования бонусов</td>
            <td>Используется только в ManagerPanel. Если значение задано true и авторизированный пользователь ManagerPanel имеет право на редактирование организаций - становятся видимы кнопки редактирования количества бонусов у клиентов.</td>
          </tr>
        </tbody>
      </table>
    </div>
