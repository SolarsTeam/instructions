      ...
      <table>
        ...
        <tbody>
          ...
          <tr class="even">
            ...
            Активация закрытия кассового дня, принимает значения:
              ...
              <ul>
				...
				<li>DoNotSeparateGroupedOrdersByGoodsCategories - не разделять сгруппирвоаные заказы по категории товаров (true - не разделять, false - разделять)</li>
          ...
          <tr>
            ...
            Использование бонусных систем (true - возможность активна, false - деактивна), имеет атрибуты:
				<ul>
					<li>IsBonusMoneyUsingActive - использование бонус денег (true - возможность активна, false - деактивна),
					обратите внимание, что для активации использования бонус-денег также необходимо активировать и использование бонусов вообще</li>
					<li>externalBonusServer - адрес бонусного процессингового центра, если задан - активируется использование внешнего процессингового центра,
					бонусы у которых поле "ExternalId" таблицы "DK_Bns" базы данных гранита будут ссылаться (выбираться и сохраняться на процессинговом центре)
					<li>externalBonusServerShopId - идентификатор текущего магазина в базе процессингового центра</li>
					<li>externalBonusServerAccessKey - зашифрованный ключ доступа текущего магазина для процессингового центра (шифрование такое же как и для пароля подключения к базе данных гранита)</li>
				</ul>
            </td>
          </tr>
          <tr class="even">
		  ...
		  <tr class="even">
            <td>EmailSettings</td>
            <td><span class="title">[Настройки подключения к серверу электронной почты](#)</span><br />
            Имеет атрибуты:
			  <ul>
			    <li>Server - адрес сервера</li>
				<li>ServerPort - порт сервера (по умолчанию 25)</li>
				<li>Email - адрес почты с которого будут слаться письма, также имя пользователя для аутентификации на сервере</li>
				<li>Password - пароль, зашифрован тем же алгоритмом, что и пароль к базе данных</li>
			  </ul>
			</td>
          </tr>
          <tr>
		  ...
		  <tr class="even">
            <td>IsClientSearchByEmailAllowed</td>
            <td><span class="title">[Разрешение поиска клиентов по email](#)</span><br />
            Значения: true - поиск разрешен, false - поиск запрещен</td>
          </tr>
          <tr>
            ...
            Информация для поиска и подтверждения клиентов по их телефону. Содержит атрибуты:
              <ul>
				...
				<li>SenderName - имя отправителя (по умолчанию "ShopSeller")</li>
              </ul>
            </td>
          </tr>
          <tr class="even">
		  ...
		  <tr>
            <td>_IsBonusCountEditAllowed_</td>
            <td><span class="title">[Разрешение редактирования бонусов](#)</span><br />
            Используется только в ManagerPanel. Если значение задано true и авторизированный пользователь ManagerPanel имеет право на редактирование организаций - становятся видимы кнопки редактирования количества бонусов у клиентов.</td>
          </tr>
		  <tr class="even">
            <td>_OrganizationDefaultCountryId_</td>
            <td><span class="title">[Страна по умолчанию для клиента](#)</span><br />
            Идентификатор страны (таблица Гранита Region), которая будет выбираться для новых клиентов по умолчанию.</td>
          </tr>
		  <tr>
            <td>_OrganizationDefaultCityId_</td>
            <td><span class="title">[Город по умолчанию для клиента](#)</span><br />
            Идентификатор города (таблица Гранита Region), которая будет выбираться для новых клиентов по умолчанию.</td>
          </tr>
		  <tr class="even">
            <td>_UseDiscountBonusSets_</td>
            <td><span class="title">[Использование автоматических скидок](#)</span><br />
            Использование автоматических наборов скидок, заданых с помощью модуля "ShopSeller.DiscountBonusManager", значения: true - использовать, false - не использовать.</td>
          </tr>
        </tbody>
      </table>
    </div>
